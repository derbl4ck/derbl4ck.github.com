...
function launchParticlesJS(e,t){function i(){pJS.fn.canvasInit(),pJS.fn.canvasSize(),pJS.fn.canvasPaint(),pJS.fn.particlesCreate(),pJS.fn.particlesDraw(),pJS.fn.densityAuto()}function a(){pJS.fn.particlesDraw(),pJS.fn.requestAnimFrame=requestAnimFrame(a)}var n=document.querySelector("#"+e+" > canvas");if(pJS={canvas:{el:n,w:n.offsetWidth,h:n.offsetHeight},particles:{color:"#fff",color_random:!1,shape:"circle",opacity:{opacity:1,anim:{enable:!1,speed:2,opacity_min:0,sync:!1}},size:2.5,size_random:!0,nb:200,line_linked:{enable_auto:!0,distance:100,color:"#fff",opacity:1,width:1,condensed_mode:{enable:!1,rotateX:3e3,rotateY:3e3}},anim:{enable:!0,speed:2},array:[]},interactivity:{enable:!0,mouse:{distance:100},detect_on:"canvas",mode:"grab",line_linked:{opacity:1},events:{onclick:{enable:!0,mode:"push",nb:4},onresize:{enable:!0,mode:"out",density_auto:!1,density_area:800}}},retina_detect:!1,fn:{vendors:{interactivity:{}}}},t){if(t.particles){var r=t.particles;if(r.color&&(pJS.particles.color=r.color),r.color_random&&(pJS.particles.color_random=r.color_random),r.shape&&(pJS.particles.shape=r.shape),r.opacity){var s=r.opacity;if(pJS.particles.opacity.opacity="object"==typeof s?s.opacity:s,s.anim){var c=s.anim;(0==c.enable||c.enable)&&(pJS.particles.opacity.anim.enable=c.enable),c.speed&&(pJS.particles.opacity.anim.speed=c.speed),c.opacity_min&&(pJS.particles.opacity.anim.opacity_min=c.opacity_min),(0==c.sync||c.sync)&&(pJS.particles.opacity.anim.sync=c.sync)}}if(r.size&&(pJS.particles.size=r.size),0==r.size_random&&(pJS.particles.size_random=r.size_random),r.nb&&(pJS.particles.nb=r.nb),r.line_linked){var o=r.line_linked;if(0==o.enable_auto&&(pJS.particles.line_linked.enable_auto=o.enable_auto),o.distance&&(pJS.particles.line_linked.distance=o.distance),o.color&&(pJS.particles.line_linked.color=o.color),o.opacity&&(pJS.particles.line_linked.opacity=o.opacity),o.width&&(pJS.particles.line_linked.width=o.width),o.condensed_mode){var p=o.condensed_mode;0==p.enable&&(pJS.particles.line_linked.condensed_mode.enable=p.enable),p.rotateX&&(pJS.particles.line_linked.condensed_mode.rotateX=p.rotateX),p.rotateY&&(pJS.particles.line_linked.condensed_mode.rotateY=p.rotateY)}}if(r.anim){var l=r.anim;0==l.enable&&(pJS.particles.anim.enable=l.enable),l.speed&&(pJS.particles.anim.speed=l.speed)}}if(t.interactivity){var d=t.interactivity;if(0==d.enable&&(pJS.interactivity.enable=d.enable),d.mouse&&d.mouse.distance&&(pJS.interactivity.mouse.distance=d.mouse.distance),d.detect_on&&(pJS.interactivity.detect_on=d.detect_on),(0==d.mode||d.mode)&&(pJS.interactivity.mode=d.mode),d.line_linked&&d.line_linked.opacity&&(pJS.interactivity.line_linked.opacity=d.line_linked.opacity),d.events){var v=d.events;if(v.onclick){var S=v.onclick;0==S.enable&&(pJS.interactivity.events.onclick.enable=!1),"push"!=S.mode&&(pJS.interactivity.events.onclick.mode=S.mode),S.nb&&(pJS.interactivity.events.onclick.nb=S.nb)}if(v.onresize){var J=v.onresize;0==J.enable&&(pJS.interactivity.events.onresize.enable=!1),J.mode&&(pJS.interactivity.events.onresize.mode=J.mode),(0==J.density_auto||J.density_auto)&&(pJS.interactivity.events.onresize.density_auto=J.density_auto),J.density_area&&(pJS.interactivity.events.onresize.density_area=J.density_area)}}}pJS.retina_detect=t.retina_detect}pJS.particles.color_rgb=hexToRgb(pJS.particles.color),pJS.particles.line_linked.color_rgb_line=hexToRgb(pJS.particles.line_linked.color),pJS.retina_detect&&window.devicePixelRatio>1&&(pJS.retina=!0,pJS.canvas.pxratio=window.devicePixelRatio,pJS.canvas.w=pJS.canvas.el.offsetWidth*pJS.canvas.pxratio,pJS.canvas.h=pJS.canvas.el.offsetHeight*pJS.canvas.pxratio,pJS.particles.anim.speed=pJS.particles.anim.speed*pJS.canvas.pxratio,pJS.particles.line_linked.distance=pJS.particles.line_linked.distance*pJS.canvas.pxratio,pJS.particles.line_linked.width=pJS.particles.line_linked.width*pJS.canvas.pxratio,pJS.interactivity.mouse.distance=pJS.interactivity.mouse.distance*pJS.canvas.pxratio),pJS.fn.canvasInit=function(){pJS.canvas.ctx=pJS.canvas.el.getContext("2d")},pJS.fn.canvasSize=function(){pJS.canvas.el.width=pJS.canvas.w,pJS.canvas.el.height=pJS.canvas.h,window.addEventListener("resize",function(){pJS&&pJS.interactivity.events.onresize.enable&&(pJS.canvas.w=pJS.canvas.el.offsetWidth,pJS.canvas.h=pJS.canvas.el.offsetHeight,pJS.retina&&(pJS.canvas.w*=pJS.canvas.pxratio,pJS.canvas.h*=pJS.canvas.pxratio),pJS.canvas.el.width=pJS.canvas.w,pJS.canvas.el.height=pJS.canvas.h,pJS.fn.canvasPaint(),pJS.particles.anim.enable||(pJS.fn.particlesRemove(),pJS.fn.canvasRemove(),i()),pJS.fn.densityAuto())})},pJS.fn.densityAuto=function(){if(pJS.interactivity.events.onresize.density_auto){var e=pJS.canvas.el.width*pJS.canvas.el.height/1e3;pJS.retina&&(e/=2*pJS.canvas.pxratio);var t=e*pJS.particles.nb/pJS.interactivity.events.onresize.density_area,i=pJS.particles.array.length-t;0>i?pJS.fn.vendors.interactivity.pushParticles(Math.abs(i)):pJS.fn.vendors.interactivity.removeParticles(i)}},pJS.fn.canvasPaint=function(){pJS.canvas.ctx.fillRect(0,0,pJS.canvas.w,pJS.canvas.h)},pJS.fn.canvasRemove=function(){pJS.canvas.ctx.clearRect(0,0,pJS.canvas.w,pJS.canvas.h)},pJS.fn.particle=function(e,t,i){this.x=i?i.x:Math.random()*pJS.canvas.w,this.y=i?i.y:Math.random()*pJS.canvas.h,this.radius=(pJS.particles.size_random?Math.random():1)*pJS.particles.size,pJS.retina&&(this.radius*=pJS.canvas.pxratio),this.color=pJS.particles.color_random?{r:Math.floor(256*Math.random())+0,g:Math.floor(256*Math.random())+0,b:Math.floor(256*Math.random())+0}:e,this.opacity=t,pJS.particles.opacity.anim.enable&&(this.opacity_status=!1,this.vo=pJS.particles.opacity.anim.speed/100,pJS.particles.opacity.anim.sync||(this.vo=this.vo*Math.random())),this.vx=-.5+Math.random(),this.vy=-.5+Math.random()},pJS.fn.particle.prototype.draw=function(){switch(pJS.canvas.ctx.fillStyle="rgba("+this.color.r+","+this.color.g+","+this.color.b+","+this.opacity+")",pJS.canvas.ctx.beginPath(),pJS.particles.shape){case"circle":pJS.canvas.ctx.arc(this.x,this.y,this.radius,0,2*Math.PI,!1);break;case"edge":pJS.canvas.ctx.rect(this.x,this.y,2*this.radius,2*this.radius);break;case"triangle":pJS.canvas.ctx.moveTo(this.x,this.y-this.radius),pJS.canvas.ctx.lineTo(this.x+this.radius,this.y+this.radius),pJS.canvas.ctx.lineTo(this.x-this.radius,this.y+this.radius),pJS.canvas.ctx.closePath()}pJS.canvas.ctx.fill()},pJS.fn.particlesCreate=function(){for(var e=0;e<pJS.particles.nb;e++)pJS.particles.array.push(new pJS.fn.particle(pJS.particles.color_rgb,pJS.particles.opacity.opacity))},pJS.fn.particlesAnimate=function(){for(var e=0;e<pJS.particles.array.length;e++){var t=pJS.particles.array[e];switch(t.x+=t.vx*(pJS.particles.anim.speed/2),t.y+=t.vy*(pJS.particles.anim.speed/2),pJS.particles.opacity.anim.enable&&(1==t.opacity_status?(t.opacity>=pJS.particles.opacity.opacity&&(t.opacity_status=!1),t.opacity+=t.vo):(t.opacity<=pJS.particles.opacity.anim.opacity_min&&(t.opacity_status=!0),t.opacity-=t.vo)),pJS.interactivity.events.onresize.mode){case"bounce":t.x-t.radius>pJS.canvas.w?t.vx=-t.vx:t.x+t.radius<0&&(t.vx=-t.vx),t.y-t.radius>pJS.canvas.h?t.vy=-t.vy:t.y+t.radius<0&&(t.vy=-t.vy);break;case"out":t.x-t.radius>pJS.canvas.w?t.x=t.radius:t.x+t.radius<0&&(t.x=pJS.canvas.w+t.radius),t.y-t.radius>pJS.canvas.h?t.y=t.radius:t.y+t.radius<0&&(t.y=pJS.canvas.h+t.radius)}for(var i=e+1;i<pJS.particles.array.length;i++){var a=pJS.particles.array[i];if(pJS.particles.line_linked.enable_auto&&pJS.fn.vendors.distanceParticles(t,a),pJS.interactivity.enable)switch(pJS.interactivity.mode){case"grab":pJS.fn.vendors.interactivity.grabParticles(t,a)}}}},pJS.fn.particlesDraw=function(){pJS.canvas.ctx.clearRect(0,0,pJS.canvas.w,pJS.canvas.h),pJS.fn.particlesAnimate();for(var e=0;e<pJS.particles.array.length;e++){var t=pJS.particles.array[e];t.draw("rgba("+t.color.r+","+t.color.g+","+t.color.b+","+t.opacity+")")}},pJS.fn.particlesRemove=function(){pJS.particles.array=[]},pJS.fn.vendors.distanceParticles=function(e,t){var i=e.x-t.x,a=e.y-t.y,n=Math.sqrt(i*i+a*a);if(n<=pJS.particles.line_linked.distance){var r=pJS.particles.line_linked.color_rgb_line;if(pJS.canvas.ctx.beginPath(),pJS.canvas.ctx.strokeStyle="rgba("+r.r+","+r.g+","+r.b+","+(pJS.particles.line_linked.opacity-n/pJS.particles.line_linked.distance)+")",pJS.canvas.ctx.moveTo(e.x,e.y),pJS.canvas.ctx.lineTo(t.x,t.y),pJS.canvas.ctx.lineWidth=pJS.particles.line_linked.width,pJS.canvas.ctx.stroke(),pJS.canvas.ctx.closePath(),pJS.particles.line_linked.condensed_mode.enable){var i=e.x-t.x,a=e.y-t.y,s=i/(1e3*pJS.particles.line_linked.condensed_mode.rotateX),c=a/(1e3*pJS.particles.line_linked.condensed_mode.rotateY);t.vx+=s,t.vy+=c}}},pJS.fn.vendors.interactivity.listeners=function(){if("window"==pJS.interactivity.detect_on)var e=window;else var e=pJS.canvas.el;if(e.onmousemove=function(t){if(e==window)var i=t.clientX,a=t.clientY;else var i=t.offsetX||t.clientX,a=t.offsetY||t.clientY;pJS&&(pJS.interactivity.mouse.pos_x=i,pJS.interactivity.mouse.pos_y=a,pJS.retina&&(pJS.interactivity.mouse.pos_x*=pJS.canvas.pxratio,pJS.interactivity.mouse.pos_y*=pJS.canvas.pxratio),pJS.interactivity.status="mousemove")},e.onmouseleave=function(){pJS&&(pJS.interactivity.mouse.pos_x=0,pJS.interactivity.mouse.pos_y=0,pJS.interactivity.status="mouseleave")},pJS.interactivity.events.onclick.enable)switch(pJS.interactivity.events.onclick.mode){case"push":e.onclick=function(){pJS.fn.vendors.interactivity.pushParticles(pJS.interactivity.events.onclick.nb,pJS.interactivity.mouse)};break;case"remove":e.onclick=function(){pJS.fn.vendors.interactivity.removeParticles(pJS.interactivity.events.onclick.nb)}}},pJS.fn.vendors.interactivity.pushParticles=function(e,t){if(pJS)for(var i=0;e>i;i++)pJS.particles.array.push(new pJS.fn.particle(pJS.particles.color_rgb,pJS.particles.opacity.opacity,{x:t?t.pos_x:Math.random()*pJS.canvas.w,y:t?t.pos_y:Math.random()*pJS.canvas.h}))},pJS.fn.vendors.interactivity.removeParticles=function(e){pJS&&pJS.particles.array.splice(0,e)},pJS.fn.vendors.interactivity.grabParticles=function(e,t){var i=e.x-t.x,a=e.y-t.y,n=Math.sqrt(i*i+a*a),r=e.x-pJS.interactivity.mouse.pos_x,s=e.y-pJS.interactivity.mouse.pos_y,c=Math.sqrt(r*r+s*s);if(n<=pJS.particles.line_linked.distance&&c<=pJS.interactivity.mouse.distance&&"mousemove"==pJS.interactivity.status){var o=pJS.particles.line_linked.color_rgb_line;pJS.canvas.ctx.beginPath(),pJS.canvas.ctx.strokeStyle="rgba("+o.r+","+o.g+","+o.b+","+(pJS.interactivity.line_linked.opacity-c/pJS.interactivity.mouse.distance)+")",pJS.canvas.ctx.moveTo(e.x,e.y),pJS.canvas.ctx.lineTo(pJS.interactivity.mouse.pos_x,pJS.interactivity.mouse.pos_y),pJS.canvas.ctx.lineWidth=pJS.particles.line_linked.width,pJS.canvas.ctx.stroke(),pJS.canvas.ctx.closePath()}},pJS.fn.vendors.destroy=function(){cancelAnimationFrame(pJS.fn.requestAnimFrame),n.remove(),pJS=null},i(),pJS.particles.anim.enable&&a(),pJS.interactivity.enable&&pJS.fn.vendors.interactivity.listeners()}function hexToRgb(e){var t=/^#?([a-f\d])([a-f\d])([a-f\d])$/i;e=e.replace(t,function(e,t,i,a){return t+t+i+i+a+a});var i=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(e);return i?{r:parseInt(i[1],16),g:parseInt(i[2],16),b:parseInt(i[3],16)}:null}window.requestAnimFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(e){window.setTimeout(e,1e3/60)}}(),window.cancelRequestAnimFrame=function(){return window.cancelAnimationFrame||window.webkitCancelRequestAnimationFrame||window.mozCancelRequestAnimationFrame||window.oCancelRequestAnimationFrame||window.msCancelRequestAnimationFrame||clearTimeout}(),window.particlesJS=function(e,t){"string"!=typeof e&&(t=e,e="particles-js"),e||(e="particles-js");var i=document.createElement("canvas");i.style.width="100%",i.style.height="100%";var a=document.getElementById(e).appendChild(i);null!=a&&launchParticlesJS(e,t)},!function(e,t){"use strict";function i(e){e=e.split(" ");for(var t={},i=e.length,a=[];i--;)t.hasOwnProperty(e[i])||(t[e[i]]=1,a.unshift(e[i]));return a.join(" ")}var a="file:"===e.location.protocol,n=t.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure","1.1"),r=Array.prototype.forEach||function(e,t){if(void 0===this||null===this||"function"!=typeof e)throw new TypeError;var i,a=this.length>>>0;for(i=0;a>i;++i)i in this&&e.call(t,this[i],i,this)},s={},c=0,o=[],p=[],l={},d=function(e){return e.cloneNode(!0)},v=function(e,t){p[e]=p[e]||[],p[e].push(t)},S=function(e){for(var t=0,i=p[e].length;i>t;t++)!function(t){setTimeout(function(){p[e][t](d(s[e]))},0)}(t)},J=function(t,i){if(void 0!==s[t])s[t]instanceof SVGSVGElement?i(d(s[t])):v(t,i);else{if(!e.XMLHttpRequest)return i("Browser does not support XMLHttpRequest"),!1;s[t]={},v(t,i);var n=new XMLHttpRequest;n.onreadystatechange=function(){if(4===n.readyState){if(404===n.status||null===n.responseXML)return i("Unable to load SVG file: "+t),a&&i("Note: SVG injection ajax calls do not work locally without adjusting security setting in your browser. Or consider using a local webserver."),i(),!1;if(!(200===n.status||a&&0===n.status))return i("There was a problem injecting the SVG: "+n.status+" "+n.statusText),!1;if(n.responseXML instanceof Document)s[t]=n.responseXML.documentElement;else if(DOMParser&&DOMParser instanceof Function){var e;try{var r=new DOMParser;e=r.parseFromString(n.responseText,"text/xml")}catch(c){e=void 0}if(!e||e.getElementsByTagName("parsererror").length)return i("Unable to parse SVG file: "+t),!1;s[t]=e.documentElement}S(t)}},n.open("GET",t),n.overrideMimeType&&n.overrideMimeType("text/xml"),n.send()}},u=function(t,a,s,p){var d=t.getAttribute("data-src")||t.getAttribute("src");if(!/\.svg/i.test(d))return void p("Attempted to inject a file with a non-svg extension: "+d);if(!n){var v=t.getAttribute("data-fallback")||t.getAttribute("data-png");return void(v?(t.setAttribute("src",v),p(null)):s?(t.setAttribute("src",s+"/"+d.split("/").pop().replace(".svg",".png")),p(null)):p("This browser does not support SVG and no PNG fallback was defined."))}-1===o.indexOf(t)&&(o.push(t),t.setAttribute("src",""),J(d,function(n){if("undefined"==typeof n||"string"==typeof n)return p(n),!1;var s=t.getAttribute("id");s&&n.setAttribute("id",s);var v=t.getAttribute("title");v&&n.setAttribute("title",v);var S=[].concat(n.getAttribute("class")||[],"injected-svg",t.getAttribute("class")||[]).join(" ");n.setAttribute("class",i(S));var J=t.getAttribute("style");J&&n.setAttribute("style",J);var u=[].filter.call(t.attributes,function(e){return/^data-\w[\w\-]*$/.test(e.name)});r.call(u,function(e){e.name&&e.value&&n.setAttribute(e.name,e.value)});for(var y,f=n.querySelectorAll("defs clipPath[id]"),m=0,h=f.length;h>m;m++){y=f[m].id+"-"+c;for(var b=n.querySelectorAll('[clip-path*="'+f[m].id+'"]'),_=0,w=b.length;w>_;_++)b[_].setAttribute("clip-path","url(#"+y+")");f[m].id=y}for(var x,g=n.querySelectorAll("defs mask[id]"),k=0,A=g.length;A>k;k++){x=g[k].id+"-"+c;for(var M=n.querySelectorAll('[mask*="'+g[k].id+'"]'),P=0,q=M.length;q>P;P++)M[P].setAttribute("mask","url(#"+x+")");g[k].id=x}n.removeAttribute("xmlns:a");for(var z,R,T=n.querySelectorAll("script"),F=[],j=0,X=T.length;X>j;j++)R=T[j].getAttribute("type"),R&&"application/ecmascript"!==R&&"application/javascript"!==R||(z=T[j].innerText||T[j].textContent,F.push(z),n.removeChild(T[j]));if(F.length>0&&("always"===a||"once"===a&&!l[d])){for(var C=0,G=F.length;G>C;C++)new Function(F[C])(e);l[d]=!0}var E=n.querySelectorAll("style");r.call(E,function(e){e.textContent+=""}),t.parentNode.replaceChild(n,t),delete o[o.indexOf(t)],t=null,c++,p(n)}))},y=function(e,t,i){t=t||{};var a=t.evalScripts||"always",n=t.pngFallback||!1,s=t.each;if(void 0!==e.length){var c=0;r.call(e,function(t){u(t,a,n,function(t){s&&"function"==typeof s&&s(t),i&&e.length===++c&&i(c)})})}else e?u(e,a,n,function(t){s&&"function"==typeof s&&s(t),i&&i(1),e=null}):i&&i(0)};"object"==typeof module&&"object"==typeof module.exports?module.exports=exports=y:"function"==typeof define&&define.amd?define(function(){return y}):"object"==typeof e&&(e.SVGInjector=y)}(window,document);